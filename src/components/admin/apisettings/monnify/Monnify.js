        ...
        <form onSubmit={handleSubmit} className="form-group">
          ...
          <div className="input-group">
            ...
            <input
              ...
              value={data[0]?.api_key || inputs.api_key}
          ...
          <div className="input-group">
            ...
            <input
              ...
              value={data[0]?.secret_key || inputs.secret_key}
              onChange={handleInput}
            />
          </div>
          <div className="input-group">
            ...
            <input
              ...
              value={data[0]?.contract_code || inputs.contract_code}
              onChange={handleInput}
            />
          </div>
          <div className="input-group">
            ...
            <input
              ...
              value={data[0]?.topUp_charges || inputs.top_up_charges}
              onChange={handleInput}
            />
          </div>
